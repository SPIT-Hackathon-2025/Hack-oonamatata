      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r
             from-green-500/10 to-purple-500/10 text-sm text-gray-400 mb-6"
          >
        ...
        <div className="relative max-w-5xl mx-auto mb-12 space-y-6">
          ...
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-r from-green-500/20 to-purple-500/20 rounded-xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500" />
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-[#1e1e2e]/80 hover:bg-[#1e1e2e] text-white
                  ...
                  placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500/50"
              />
            </div>
          </div>
                ...
                className={`
                    ...
                    ${
                      selectedLanguage === lang
                        ? "text-green-400 bg-green-500/10 ring-2 ring-green-500/50"
